// До этого не был знаком с bacbone.js вот что получилось,
// до AJAX не успел дойти, если хотите могу сделать такое
// приложение на чистом JS с AJAX запросами, и сервером))
